    ...
    static class Entry {
        static void Main(string[] args) {
            try {
                ...
                ConstructorInfo ctor = RenderContextFactory.GetTypeInfo().GetConstructor(new Type[0]);
                ...
                MethodInfo Run = ApplicationSetup.GetTypeInfo().GetMethod("Run", BindingFlags.NonPublic | BindingFlags.Static);
