...
namespace Com.GitHub.ZachDeibert.GraphicsCore {
    ...
    public interface IOpenGLContext : IRenderContext {
        ...
        void ActiveVaryingNV(uint @program, string @name);
        ...
        void BindAttribLocationARB(IntPtr @programObj, uint @index, string @name);
        ...
        void BindFragDataLocationEXT(uint @program, uint @color, string @name);
        void BindFragDataLocationIndexed(uint @program, uint @colorNumber, uint @index, string @name);
        void BindFragDataLocationIndexedEXT(uint @program, uint @colorNumber, uint @index, string @name);
        ...
        void CompileShaderIncludeARB(uint @shader, int @count, string[] @path, int[] @length);
        ...
        uint CreateShaderProgramEXT(GlShaderType @type, string @string);
        uint CreateShaderProgramv(GlShaderType @type, int @count, string[] @strings);
        uint CreateShaderProgramvEXT(GlShaderType @type, int @count, string[] @strings);
        ...
        void DebugMessageInsert(GlDebugSource @source, GlDebugType @type, uint @id, GlDebugSeverity @severity, int @length, string @buf);
        void DebugMessageInsertAMD(uint @category, GlDebugSeverity @severity, uint @id, int @length, string @buf);
        void DebugMessageInsertARB(GlDebugSource @source, GlDebugType @type, uint @id, GlDebugSeverity @severity, int @length, string @buf);
        void DebugMessageInsertKHR(GlDebugSource @source, GlDebugType @type, uint @id, GlDebugSeverity @severity, int @length, string @buf);
        ...
        void DeleteNamedStringARB(int @namelen, string @name);
        ...
        void ExtGetProgramBinarySourceQCOM(uint @program, GlShaderType @shadertype, string @source, int[] @length);
        ...
        void GetActiveAttrib(uint @program, uint @index, int @bufSize, int[] @length, int[] @size, GlAttributeType[] @type, string @name);
        void GetActiveAttribARB(IntPtr @programObj, uint @index, int @maxLength, int[] @length, int[] @size, GlAttributeType[] @type, string @name);
        void GetActiveSubroutineName(uint @program, GlShaderType @shadertype, uint @index, int @bufsize, int[] @length, string @name);
        void GetActiveSubroutineUniformName(uint @program, GlShaderType @shadertype, uint @index, int @bufsize, int[] @length, string @name);
        ...
        void GetActiveUniform(uint @program, uint @index, int @bufSize, int[] @length, int[] @size, GlAttributeType[] @type, string @name);
        void GetActiveUniformARB(IntPtr @programObj, uint @index, int @maxLength, int[] @length, int[] @size, GlAttributeType[] @type, string @name);
        void GetActiveUniformBlockName(uint @program, uint @uniformBlockIndex, int @bufSize, int[] @length, string @uniformBlockName);
        void GetActiveUniformBlockiv(uint @program, uint @uniformBlockIndex, GlUniformBlockPName @pname, int[] @params);
        void GetActiveUniformName(uint @program, uint @uniformIndex, int @bufSize, int[] @length, string @uniformName);
        void GetActiveUniformsiv(uint @program, int @uniformCount, uint[] @uniformIndices, GlUniformPName @pname, int[] @params);
        void GetActiveVaryingNV(uint @program, uint @index, int @bufSize, int[] @length, int[] @size, uint[] @type, string @name);
        ...
        int GetAttribLocationARB(IntPtr @programObj, string @name);
        ...
        uint GetDebugMessageLog(uint @count, int @bufSize, GlDebugSource[] @sources, GlDebugType[] @types, uint[] @ids, GlDebugSeverity[] @severities, int[] @lengths, string @messageLog);
        uint GetDebugMessageLogAMD(uint @count, int @bufsize, uint[] @categories, GlDebugSeverity[] @severities, uint[] @ids, int[] @lengths, string @message);
        uint GetDebugMessageLogARB(uint @count, int @bufSize, GlDebugSource[] @sources, GlDebugType[] @types, uint[] @ids, GlDebugSeverity[] @severities, int[] @lengths, string @messageLog);
        uint GetDebugMessageLogKHR(uint @count, int @bufSize, GlDebugSource[] @sources, GlDebugType[] @types, uint[] @ids, GlDebugSeverity[] @severities, int[] @lengths, string @messageLog);
        ...
        void GetDriverControlStringQCOM(uint @driverControl, int @bufSize, int[] @length, string @driverControlString);
        ...
        int GetFragDataIndexEXT(uint @program, string @name);
        int GetFragDataLocation(uint @program, string @name);
        int GetFragDataLocationEXT(uint @program, string @name);
        ...
        void GetInfoLogARB(IntPtr @obj, int @maxLength, int[] @length, string @infoLog);
        ...
        void GetNamedStringARB(int @namelen, string @name, int @bufSize, int[] @stringlen, string @string);
        void GetNamedStringivARB(int @namelen, string @name, uint @pname, int[] @params);
        ...
        void GetObjectLabel(uint @identifier, uint @name, int @bufSize, int[] @length, string @label);
        void GetObjectLabelEXT(uint @type, uint @object, int @bufSize, int[] @length, string @label);
        void GetObjectLabelKHR(uint @identifier, uint @name, int @bufSize, int[] @length, string @label);
        ...
        void GetObjectPtrLabel(byte[] @ptr, int @bufSize, int[] @length, string @label);
        void GetObjectPtrLabelKHR(byte[] @ptr, int @bufSize, int[] @length, string @label);
        ...
        void GetPerfCounterInfoINTEL(uint @queryId, uint @counterId, uint @counterNameLength, string @counterName, uint @counterDescLength, string @counterDesc, uint[] @counterOffset, uint[] @counterDataSize, uint[] @counterTypeEnum, uint[] @counterDataTypeEnum, ulong[] @rawCounterMaxValue);
        ...
        void GetPerfMonitorCounterStringAMD(uint @group, uint @counter, int @bufSize, int[] @length, string @counterString);
        void GetPerfMonitorCountersAMD(uint @group, int[] @numCounters, int[] @maxActiveCounters, int @counterSize, uint[] @counters);
        void GetPerfMonitorGroupStringAMD(uint @group, int @bufSize, int[] @length, string @groupString);
        ...
        void GetPerfQueryIdByNameINTEL(string @queryName, uint[] @queryId);
        void GetPerfQueryInfoINTEL(uint @queryId, uint @queryNameLength, string @queryName, uint[] @dataSize, uint[] @noCounters, uint[] @noInstances, uint[] @capsMask);
        ...
        void GetProgramInfoLog(uint @program, int @bufSize, int[] @length, string @infoLog);
        ...
        void GetProgramPipelineInfoLog(uint @pipeline, int @bufSize, int[] @length, string @infoLog);
        void GetProgramPipelineInfoLogEXT(uint @pipeline, int @bufSize, int[] @length, string @infoLog);
        ...
        uint GetProgramResourceIndex(uint @program, GlProgramInterface @programInterface, string @name);
        int GetProgramResourceLocation(uint @program, GlProgramInterface @programInterface, string @name);
        int GetProgramResourceLocationIndex(uint @program, GlProgramInterface @programInterface, string @name);
        int GetProgramResourceLocationIndexEXT(uint @program, GlProgramInterface @programInterface, string @name);
        void GetProgramResourceName(uint @program, GlProgramInterface @programInterface, uint @index, int @bufSize, int[] @length, string @name);
        ...
        void GetShaderInfoLog(uint @shader, int @bufSize, int[] @length, string @infoLog);
        void GetShaderPrecisionFormat(GlShaderType @shadertype, GlPrecisionType @precisiontype, int[] @range, int[] @precision);
        void GetShaderSource(uint @shader, int @bufSize, int[] @length, string @source);
        void GetShaderSourceARB(IntPtr @obj, int @maxLength, int[] @length, string @source);
        ...
        uint GetSubroutineIndex(uint @program, GlShaderType @shadertype, string @name);
        int GetSubroutineUniformLocation(uint @program, GlShaderType @shadertype, string @name);
        ...
        void GetTransformFeedbackVarying(uint @program, uint @index, int @bufSize, int[] @length, int[] @size, uint[] @type, string @name);
        void GetTransformFeedbackVaryingEXT(uint @program, uint @index, int @bufSize, int[] @length, int[] @size, uint[] @type, string @name);
        ...
        void GetTranslatedShaderSourceANGLE(uint @shader, int @bufsize, int[] @length, string @source);
        ...
        int GetUniformLocationARB(IntPtr @programObj, string @name);
        ...
        int GetVaryingLocationNV(uint @program, string @name);
        ...
        void InsertEventMarkerEXT(int @length, string @marker);
        ...
        bool IsNamedStringARB(int @namelen, string @name);
        ...
        void LabelObjectEXT(uint @type, uint @object, int @length, string @label);
        ...
        void NamedStringARB(uint @type, int @namelen, string @name, int @stringlen, string @string);
        ...
        void ObjectLabel(GlObjectIdentifier @identifier, uint @name, int @length, string @label);
        void ObjectLabelKHR(GlObjectIdentifier @identifier, uint @name, int @length, string @label);
        void ObjectPtrLabel(byte[] @ptr, int @length, string @label);
        void ObjectPtrLabelKHR(byte[] @ptr, int @length, string @label);
        ...
        void PushDebugGroup(GlDebugSource @source, uint @id, int @length, string @message);
        void PushDebugGroupKHR(GlDebugSource @source, uint @id, int @length, string @message);
        void PushGroupMarkerEXT(int @length, string @marker);
        void PushMatrix();
        ...
        void QueryResourceTagNV(int @tagId, string @tagString);
        ...
        void ShaderSourceARB(IntPtr @shaderObj, int @count, string[] @string, int[] @length);
        ...
        void SpecializeShaderARB(uint @shader, string @pEntryPoint, uint @numSpecializationConstants, uint[] @pConstantIndex, uint[] @pConstantValue);
        ...
        void TransformFeedbackVaryings(uint @program, int @count, string[] @varyings, uint @bufferMode);
        void TransformFeedbackVaryingsEXT(uint @program, int @count, string[] @varyings, uint @bufferMode);
        ...
        IntPtr GetVkProcAddrNV(string @name);
